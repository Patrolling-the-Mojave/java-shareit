...
public class BookingServiceImpl implements BookingService {
    ...
    public Collection<BookingDto> findAllByItemOwnerAndState(int ownerId, String state) {
        ...
        switch (bookingState) {
            ...
            case WAITING -> bookings = bookingRepository.findAllByItemOwnerAndStatus(ownerId, "WAITING");
            case REJECTED -> bookings = bookingRepository.findAllByItemOwnerAndStatus(ownerId, "REJECTED");
            default -> throw new IllegalArgumentException("неизвестное состояние: " + bookingState);
        }
        return toDto(bookings);
    }
